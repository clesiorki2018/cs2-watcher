...
# resolve links para permitir execucao via atalho no PATH.
...
PRESERVE_ENV="CS2_HOTKEY_MAIN_MODE,CS2_HOTKEY_SIDE_MODE,CS2_HOTKEY_EXIT,CS2_HOLD_KEY_FORWARD,CS2_HOLD_KEY_RIGHT,CS2_HOLD_KEY_LEFT,CS2_EFFECT_KEY,CS2_ACTION_DURATION,CS2_CLICK_DEBOUNCE,CS2_HOLD_REFRESH_INTERVAL,CS2_HOTKEY_DEBOUNCE,CS2_SIDE_SWITCH_MIN_INTERVAL,CS2_SIDE_SWITCH_MAX_INTERVAL"

cd "$PROJECT_DIR"

# sudo preserva apenas as variaveis necessarias ao watcher.
if [ "$USE_SUDO" = "1" ]; then
